...
function getFileExtension(fileName){
    let lastIndex = fileName.lastIndexOf("."); //locating where to start

    let fileExtension = fileName.substring(lastIndex +1); //adding one after "."

    return fileExtension.toLocaleLowerCase(); //lowercasing letters, keeping it local to us. 
